...
const characters = [
  { id: "mickey", name: "Mickey Mouse", image: "/images/avatars/avatar-1.jpg", color: "#EF4444" },
  { id: "elsa", name: "Elsa", image: "/images/avatars/avatar-2.jpg", color: "#3B82F6" },
  { id: "spidey", name: "Spidey", image: "/images/avatars/avatar-3.jpg", color: "#DC2626" },
  { id: "dora", name: "Dora", image: "/images/avatars/avatar-4.jpg", color: "#EC4899" },
  { id: "paw", name: "Paw Patrol", image: "/images/avatars/avatar-1.jpg", color: "#2563EB" },
  { id: "peppa", name: "Peppa Pig", image: "/images/avatars/avatar-2.jpg", color: "#F472B6" },
];
        ...
        <Grid container spacing={3}>
          {kidsShows.map((show) => (
            <Grid size={{ xs: 6, sm: 4, md: 3, lg: 2 }} key={show.id}>
              <Link href={`/kids/watch/${show.id}`} style={{ textDecoration: "none" }}>
                <Box
                  sx={{
                    ...kidsGlassCardSx,
                    transition: "all 0.3s ease",
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <PlayArrowIcon sx={{ fontSize: "2rem", color: show.color }} />
                      </Box>
                    </Box>
                    {/* Rating Badge */}
                    <Box
