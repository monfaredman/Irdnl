  ...
  return (
    ...
    >
      ...
      <Skeleton
        ...
        width={80}
        height={120}
        sx={{ borderRadius: glassBorderRadius.lg, bgcolor: glassColors.glass.mid }}
      />
      <Box sx={{ flex: 1 }}>
        <Skeleton
          variant="text"
            ...
            >
              ...
              >
                ...
                >
                  <Typography
                    sx={{
                      ...
                      fontWeight: 800,
                      color: index < 3 ? glassColors.persianGold : glassColors.text.primary,
                    }}
                  >
                    {index + 1}
                  </Typography>
                ...
                >
                  ...
                  >
                    <StarIcon sx={{ color: glassColors.persianGold, fontSize: "1.25rem" }} />
                    <Typography
                      sx={{
                        color: glassColors.text.primary,
                        fontWeight: 700,
                ...
                >
                  <StarIcon sx={{ color: glassColors.persianGold, fontSize: "1rem" }} />
                  <Typography
                    sx={{
                      color: glassColors.text.primary,
                      fontWeight: 700,
