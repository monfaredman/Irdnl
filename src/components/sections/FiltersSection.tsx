...
import { Box, Typography, Select, MenuItem, Slider, FormControl } from "@mui/material";
        ...
        >
          ...
          <FormControl>
            ...
            >
              ...
              <MenuItem value="movie">{language === "fa" ? "فیلم" : "Movie"}</MenuItem>
              <MenuItem value="series">{language === "fa" ? "سریال" : "Series"}</MenuItem>
              <MenuItem value="animation">{language === "fa" ? "انیمیشن" : "Animation"}</MenuItem>
            </Select>
          </FormControl>
          ...
          <FormControl>
            ...
            >
              <MenuItem value="all">{language === "fa" ? "همه" : "All"}</MenuItem>
              <MenuItem value="action">{language === "fa" ? "اکشن" : "Action"}</MenuItem>
              <MenuItem value="drama">{language === "fa" ? "درام" : "Drama"}</MenuItem>
              <MenuItem value="comedy">{language === "fa" ? "کمدی" : "Comedy"}</MenuItem>
              <MenuItem value="thriller">{language === "fa" ? "هیجان‌انگیز" : "Thriller"}</MenuItem>
              <MenuItem value="horror">{language === "fa" ? "ترسناک" : "Horror"}</MenuItem>
            </Select>
          </FormControl>
          ...
          <FormControl>
            ...
            >
              <MenuItem value="all">{language === "fa" ? "همه" : "All"}</MenuItem>
              <MenuItem value="iran">{language === "fa" ? "ایران" : "Iran"}</MenuItem>
              <MenuItem value="usa">{language === "fa" ? "آمریکا" : "USA"}</MenuItem>
              <MenuItem value="uk">{language === "fa" ? "انگلیس" : "UK"}</MenuItem>
              <MenuItem value="korea">{language === "fa" ? "کره" : "Korea"}</MenuItem>
              <MenuItem value="japan">{language === "fa" ? "ژاپن" : "Japan"}</MenuItem>
            </Select>
          </FormControl>
          ...
          <FormControl>
            ...
            >
              <Slider
                ...
                onChange={(_, value) => handleFilterChange("yearRange", value as [number, number])}
          ...
          <FormControl>
            ...
            >
              ...
              <MenuItem value="pg13">{language === "fa" ? "+۱۳" : "PG-13"}</MenuItem>
