...
import { Box, Typography, Button, Stack, Chip, IconButton, useTheme } from "@mui/material";
          ...
          {[1, 2, 3, 4, 5].map((dot, index) => (
            <Box
              ...
              sx={{
                ...
                height: 8,
                borderRadius: 4,
                background: index === 0 ? theme.palette.secondary.main : 'rgba(255, 255, 255, 0.3)',
                transition: 'all 0.3s',
                cursor: 'pointer',
                '&:hover': {
                  background: index === 0 ? theme.palette.secondary.light : 'rgba(255, 255, 255, 0.5)',
                },
              }}
            />
          ))}
