...
import { Button, Stack, Avatar, useTheme } from "@mui/material";
      ...
      {profiles.map((profile) => (
        <Button
          ...
          startIcon={
            <Avatar
              ...
              sx={{
                width: 24,
                height: 24,
                border: profile.id === activeProfileId ? `2px solid ${theme.palette.primary.light}80` : 'none',
                transition: 'all 0.3s',
              }}
            />
          }
          sx={{
            ...
            fontWeight: 500,
            textTransform: 'none',
            color: profile.id === activeProfileId ? theme.palette.primary.light : 'rgba(255, 255, 255, 0.7)',
            transition: 'all 0.2s',
            '&:hover': {
