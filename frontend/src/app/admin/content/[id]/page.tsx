...
import { contentApi, seasonsApi, episodesApi } from '@/lib/api/admin';
            ...
            <form onSubmit={handleCreateEpisode} className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEpisodeForm({ ...episodeForm, seasonId: e.target.value })
                    }
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEpisodeForm({ ...episodeForm, description: e.target.value })
                  }
                  className="w-full rounded-md border border-gray-300 px-3 py-2"
                  rows={3}
                />
