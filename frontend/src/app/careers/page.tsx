...
const jobs = [
  {
    ...
    descriptionFa: "ساخت رابط‌های کاربری زیبا و با کارایی بالا با React و Next.js",
  },
  {
    id: 2,
        ...
        {Object.entries(t.benefits).map(([key, benefit]) => {
          ...
          return (
            <Grid size={{ xs: 12, md: 4 }} key={key}>
              <Box sx={glassCardSx}>
                <Icon sx={{ fontSize: "2.5rem", color: glassColors.persianGold, mb: 2 }} />
                <Typography
                  variant="h6"
        ...
        {jobs.map((job) => (
          ...
          >
            <Box>
              ...
              <Typography
                sx={{ color: glassColors.text.tertiary, fontSize: "0.9rem", mb: 2 }}
              >
