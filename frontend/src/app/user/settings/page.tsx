	...
	return (
		<Box sx={{ maxWidth: 800, mx: "auto" }}>
			...
			<Box sx={glassCardSx}>
				<Typography
					variant="h6"
					sx={{ color: glassColors.text.primary, fontWeight: 600, mb: 2 }}
				>
					{t.appearance}
				</Typography>
			...
			<Box sx={glassCardSx}>
				...
				<SettingRow icon={NotificationsIcon} label={t.emailNotifs}>
					<Switch
						...
						onChange={(e) =>
							setSettings({ ...settings, emailNotifs: e.target.checked })
						}
						sx={{
							"& .MuiSwitch-switchBase.Mui-checked": {
								color: glassColors.persianGold,
				...
				<SettingRow icon={SubtitlesIcon} label={t.subtitles}>
					<FormControl size="small" sx={{ minWidth: 150, ...glassSelectSx }}>
						<Select
							...
							onChange={(e) =>
								setSettings({ ...settings, subtitles: e.target.value })
							}
						>
				...
				<Box sx={{ py: 2 }}>
					...
					<Box sx={{ px: 2 }}>
						<Slider
							...
							onChange={(_, value) =>
								setSettings({ ...settings, subtitleSize: value as number })
							}
							min={25}
							max={100}
							marks={[
			...
			<Box sx={glassCardSx}>
				...
				<SettingRow icon={ChildCareIcon} label={t.kidsMode}>
					<Switch
						...
						onChange={(e) =>
							setSettings({ ...settings, kidsMode: e.target.checked })
						}
						sx={{
							"& .MuiSwitch-switchBase.Mui-checked": {
								color: glassColors.persianGold,
				...
				<SettingRow icon={ChildCareIcon} label={t.pinRequired}>
					<Switch
						...
						onChange={(e) =>
							setSettings({ ...settings, pinRequired: e.target.checked })
						}
						sx={{
							"& .MuiSwitch-switchBase.Mui-checked": {
								color: glassColors.persianGold,
				...
				<SettingRow icon={StorageIcon} label={t.downloadQuality}>
					<FormControl size="small" sx={{ minWidth: 150, ...glassSelectSx }}>
						<Select
							...
							onChange={(e) =>
								setSettings({ ...settings, downloadQuality: e.target.value })
							}
						>
							<MenuItem value="low">{t.low}</MenuItem>
							<MenuItem value="medium">{t.medium}</MenuItem>
