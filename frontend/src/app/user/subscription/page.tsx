...
const plans = [
  ...
  },
  {
    ...
    monthlyPrice: 19.99,
    yearlyPrice: 199,
    features: ["ads", "quality4k", "devices4", "downloadUnlimited", "hdr", "atmos", "earlyAccess"] as const,
  ...
  return (
    <Box>
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 4 }}>
        <CardMembershipIcon sx={{ color: glassColors.persianGold, fontSize: "2rem" }} />
      ...
      >
        <Button
          ...
          sx={{
            ...
            py: 1,
            borderRadius: glassBorderRadius.pill,
            background: billingPeriod === "monthly" ? glassColors.persianGold : "transparent",
            color: billingPeriod === "monthly" ? "#000" : glassColors.text.secondary,
            fontWeight: 600,
            textTransform: "none",
            "&:hover": {
              background: billingPeriod === "monthly" ? glassColors.persianGold : glassColors.glass.mid,
            },
          }}
        >
          {t.monthly}
        ...
        <Button
          ...
          sx={{
            ...
            py: 1,
            borderRadius: glassBorderRadius.pill,
            background: billingPeriod === "yearly" ? glassColors.persianGold : "transparent",
            color: billingPeriod === "yearly" ? "#000" : glassColors.text.secondary,
            fontWeight: 600,
            textTransform: "none",
            "&:hover": {
              background: billingPeriod === "yearly" ? glassColors.persianGold : glassColors.glass.mid,
            },
          }}
        >
          {t.yearly}
      ...
      >
        {plans.map((plan) => {
          ...
          const priceLabel = billingPeriod === "monthly" ? t.perMonth : t.perYear;
          ...
          return (
            <Box
              ...
              sx={{
                ...glassCardSx,
                borderColor: isCurrentPlan ? plan.color : glassColors.glass.border,
                  ...
                  <ListItem key={feature} sx={{ px: 0, py: 0.5 }}>
                    ...
                    <ListItemText
                      ...
                      primaryTypographyProps={{
                        sx: { color: glassColors.text.secondary, fontSize: "0.9rem" },
                      }}
                    />
                  </ListItem>
                ))}
