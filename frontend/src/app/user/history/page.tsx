...
const getProgress = (index: number) => {
  const progressValues = [35, 62, 48, 75, 100, 100, 100, 100, 100, 100, 100, 100];
...
const getWatchedDate = (index: number, locale: string) => {
  ...
  const dates = [
    "2024-12-10", "2024-12-09", "2024-12-08", "2024-12-07",
    "2024-12-06", "2024-12-05", "2024-12-04", "2024-12-03",
    "2024-12-02", "2024-12-01", "2024-11-30", "2024-11-29",
  ];
...
export default function HistoryPage() {
  ...
  const historyItems = movies?.slice(0, 12).map((movie, index) => ({
    ...movie,
  ...
  if (loading) {
    return (
      <Box sx={{ maxWidth: 1200, mx: "auto" }}>
        <Skeleton variant="text" width={200} height={40} sx={{ bgcolor: glassColors.glass.base, mb: 3 }} />
        <Grid container spacing={2}>
          {[...Array(4)].map((_, i) => (
            <Grid size={{ xs: 12, sm: 6, md: 3 }} key={i}>
              <Skeleton variant="rounded" height={200} sx={{ bgcolor: glassColors.glass.base, borderRadius: glassBorderRadius.lg }} />
            </Grid>
          ))}
        </Grid>
      </Box>
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto" }}>
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 4 }}>
        <HistoryIcon sx={{ color: glassColors.persianGold, fontSize: "2rem" }} />
      ...
      {historyItems.length === 0 ? (
        ...
        >
          <HistoryIcon sx={{ fontSize: 80, color: glassColors.text.tertiary, mb: 2 }} />
                      ...
                      >
                        <Box sx={{ position: "relative", aspectRatio: "16/9" }}>
                          ...
                          >
                            ...
                            >
                              <PlayArrowIcon sx={{ color: glassColors.black, fontSize: "2rem" }} />
                            </Box>
                          </Box>
                      ...
                      >
                        ...
                        <Box sx={{ p: 1.5 }}>
                          ...
                          <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, mt: 0.5 }}>
                            <AccessTimeIcon sx={{ fontSize: "0.75rem", color: glassColors.text.tertiary }} />
                            <Typography sx={{ color: glassColors.text.tertiary, fontSize: "0.7rem" }}>
                              {item.watchedAt}
                            </Typography>
                          </Box>
                        </Box>
